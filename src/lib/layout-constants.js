...
// this controls the size of the stage
...
STAGE_DISPLAY_SCALES[STAGE_DISPLAY_SIZES.hide] = 0.0; // small mode, regardless of browser size
STAGE_DISPLAY_SCALES[STAGE_DISPLAY_SIZES.bottom] = 0.1; // shifted to bottom
