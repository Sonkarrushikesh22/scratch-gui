...
import hideScreenIcon from "./icon--hidescreen-stage.svg";
import bottomstageIcon from "./icon--bottom-stage.svg";
...
const messages = defineMessages({
    ...
    hideStageMessage: {
        ...
        description: "Hide the stage",
        id: "gui.stageHeader.hide",
    },
    bottomStageMessage: {
        defaultMessage: "Move Stage to bottom",
        description: "Move the stage to the bottom ",
        id: "gui.stageHeader.toBottom",
    },
});
...
const StageHeaderComponent = function (props) {
    const {
        ...
        onSetStageSmall,
        onSetStageHide, //hide
        onSetStageBottom, //stage at bottom
        onSetStageFull,
        onSetStageUnFull,
        showBranding,
        stageSizeMode,
            ...
            <div className={styles.stageSizeToggleGroup}>
                <ToggleButtons
                    buttons={[
                        ...
                        {
                            handleClick: onSetStageHide,
                            icon: hideScreenIcon,
                            iconClassName: styles.stageButtonIcon,
                            isSelected: stageSizeMode === STAGE_SIZE_MODES.hide,
                            title: props.intl.formatMessage(
                                messages.hideStageMessage
                            ),
                        },
                        {
                            handleClick: onSetStageBottom,
                            icon: bottomstageIcon,
                            iconClassName: styles.stageButtonIcon,
                            isSelected:
                                stageSizeMode === STAGE_SIZE_MODES.bottom,
                            title: props.intl.formatMessage(
                                messages.bottomStageMessage
                            ),
                        },
                    ]}
                />
...
StageHeaderComponent.propTypes = {
    ...
    onSetStageBottom: PropTypes.func.isRequired,
